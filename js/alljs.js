document.writeln("<script async src=\'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6444660083939297\'");
document.writeln("     crossorigin=\'anonymous\'></script>");

document.domain = "txhot.cn";
user_agent = navigator.userAgent.toLowerCase();

function all_zhi_xing_js_head() {
    if (typeof (HL.Cookie.Get("all_jie_mian")) == "undefined") {
        if (window.screen.width >= 1280) {
            document.write('<link href="//t.txhot.cn/css/1040.css?v=' + cache_sjs + '" rel="stylesheet" type="text/css" />')
        }
        if (sj_jie_mian == "1") {
            document.write('<link href="//t.txhot.cn/css/sj.css?v=' + cache_sjs + '" rel="stylesheet" type="text/css" media="screen and (max-width:800px)" />');
        ...
        if (HL.Cookie.Get("all_jie_mian") == "sj" && sj_jie_mian == "1") {
            document.write('<link href="//t.txhot.cn/css/sj.css?v=' + cache_sjs + '" rel="stylesheet" type="text/css" />');
            if (typeof (css_file_sj) != "undefined") {
    ...
    try {
        parent.parent_ture();
        document.write('<link href="//t.txhot.cn/api.css?v=' + cache_sjs + '" rel="stylesheet" type="text/css" />')
    } catch (a) {
    }
    c_y_g_j_set()
}
...
function jie_mian_qie_huan_set(a) {
    HL.Cookie.Set("all_jie_mian", a, 60 * 60 * 24 * 365, "/", "txhot.cn");
    location.reload();
    return false
}

function jie_mian_qie_huan_del() {
    HL.Cookie.Del("all_jie_mian", "/", "txhot.cn");
    location.reload();
    return false
}
...
function all_you_xia_jiao() {
    ...
    a += '<a href="#" class="xiao_fang_kuai_liu_yan"></a>';
    a += "</div>";
    a += "</div>";
    document.write(a)
}
...
function c_y_g_j_set() {
    ...
    HL.Cookie.Set("c_y_g_j", d, 60 * 60 * 24 * 365, "/", "txhot.cn")
}
